...
esp_err_t i2c::writeByte(uint8_t addr, uint8_t reg, uint8_t byte){
    ...
    i2c_master_write_byte(hCmd, reg, true);
...
esp_err_t i2c::writeBytes(uint8_t addr, uint8_t reg, uint8_t * data, int dataLen){
    i2c_cmd_handle_t hCmd = i2c_cmd_link_create();
    i2c_master_start(hCmd);
...
esp_err_t i2c::readBytes(uint8_t addr, uint8_t reg, uint8_t * data, int dataLen){
    i2c_cmd_handle_t hCmd = i2c_cmd_link_create();
    i2c_master_start(hCmd);
